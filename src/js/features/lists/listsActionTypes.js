...
export const UPDATE_LIST_FAILURE = ns('UPDATE_LIST_FAILURE');

export const DELETE_LIST_REQUEST = ns('DELETE_LIST_REQUEST');
export const DELETE_LIST_SUCCESS = ns('DELETE_LIST_SUCCESS');
export const DELETE_LIST_FAILURE = ns('DELETE_LIST_FAILURE');
